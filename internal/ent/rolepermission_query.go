...
type RolePermissionQuery struct {
	...
	withPermission *TreasuryPermissionQuery
...
func (_q *RolePermissionQuery) QueryRole() *TreasuryRoleQuery {
...
func (_q *RolePermissionQuery) QueryPermission() *TreasuryPermissionQuery {
...
func (_q *RolePermissionQuery) WithRole(opts ...func(*TreasuryRoleQuery)) *RolePermissionQuery {
	query := (&TreasuryRoleClient{config: _q.config}).Query()
...
func (_q *RolePermissionQuery) WithPermission(opts ...func(*TreasuryPermissionQuery)) *RolePermissionQuery {
	query := (&TreasuryPermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RolePermissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*RolePermission, error) {
	...
	if query := _q.withRole; query != nil {
		if err := _q.loadRole(ctx, query, nodes, nil,
			func(n *RolePermission, e *TreasuryRole) { n.Edges.Role = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPermission; query != nil {
		if err := _q.loadPermission(ctx, query, nodes, nil,
			func(n *RolePermission, e *TreasuryPermission) { n.Edges.Permission = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RolePermissionQuery) loadRole(ctx context.Context, query *TreasuryRoleQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *TreasuryRole)) error {
...
func (_q *RolePermissionQuery) loadPermission(ctx context.Context, query *TreasuryPermissionQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *TreasuryPermission)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*RolePermission)
	for i := range nodes {
	...
	query.Where(treasurypermission.IDIn(ids...))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	}
