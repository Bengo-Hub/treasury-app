...
func HasRoleWith(preds ...predicate.TreasuryRole) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
		step := newRoleStep()
...
func HasPermissionWith(preds ...predicate.TreasuryPermission) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
