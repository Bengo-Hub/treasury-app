...
func (_c *RolePermissionCreate) SetRole(v *TreasuryRole) *RolePermissionCreate {
	return _c.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the TreasuryPermission entity.
func (_c *RolePermissionCreate) SetPermission(v *TreasuryPermission) *RolePermissionCreate {
