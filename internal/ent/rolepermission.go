...
type RolePermissionEdges struct {
	...
	Permission *TreasuryPermission `json:"permission,omitempty"`
...
func (e RolePermissionEdges) RoleOrErr() (*TreasuryRole, error) {
	if e.Role != nil {
		return e.Role, nil
...
// was not loaded in eager-loading, or loaded but was not found.
func (e RolePermissionEdges) PermissionOrErr() (*TreasuryPermission, error) {
	if e.Permission != nil {
		return e.Permission, nil
	} else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: treasurypermission.Label}
	}
...
func (_m *RolePermission) QueryRole() *TreasuryRoleQuery {
...
func (_m *RolePermission) QueryPermission() *TreasuryPermissionQuery {
