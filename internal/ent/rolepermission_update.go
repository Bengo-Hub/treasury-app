...
func (_u *RolePermissionUpdate) SetRole(v *TreasuryRole) *RolePermissionUpdate {
	return _u.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the TreasuryPermission entity.
func (_u *RolePermissionUpdate) SetPermission(v *TreasuryPermission) *RolePermissionUpdate {
...
// SetRole sets the "role" edge to the TreasuryRole entity.
func (_u *RolePermissionUpdateOne) SetRole(v *TreasuryRole) *RolePermissionUpdateOne {
	return _u.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the TreasuryPermission entity.
func (_u *RolePermissionUpdateOne) SetPermission(v *TreasuryPermission) *RolePermissionUpdateOne {
	return _u.SetPermissionID(v.ID)
}
